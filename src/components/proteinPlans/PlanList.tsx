...
import { Edit, Trash2, Beef, Calendar, ChevronUp, ChevronDown, ChevronsUpDown } from 'lucide-react';
...
interface PlanListProps {
  plans: ProteinPlan[];
  onEdit: (plan: ProteinPlan) => void;
  onDelete: (plan: ProteinPlan) => void;
  loading?: boolean;
    ...
    return (
      <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2">
          No se encontraron planes de proteína
        </h3>
            ...
            <div className="md:hidden">
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    title="Editar plan"
                    aria-label={`Editar plan ${plan.protein_plans_name}`}
                  >
                  ...
                  <button
                    ...
                    title="Eliminar plan"
                    aria-label={`Eliminar plan ${plan.protein_plans_name}`}
                  >
              ...
              <div className="mb-3">
                ...
                <p className="text-lg font-semibold text-gray-900">
                  {formatCurrency(plan.protein_plans_price)}
                </p>
              </div>
            </div>
