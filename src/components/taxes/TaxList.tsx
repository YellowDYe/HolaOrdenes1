...
import { Edit, Trash2, Calculator, Calendar, ChevronUp, ChevronDown, ChevronsUpDown } from 'lucide-react';
    ...
    return (
      <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
        ...
        <p className="text-gray-600">
          No hay impuestos que coincidan con los criterios de búsqueda
        </p>
      </div>
    );
  }
            ...
            <div className="md:hidden">
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    aria-label={`Editar impuesto ${tax.tax_name}`}
                  >
                  ...
                  <button
                    ...
                    aria-label={`Eliminar impuesto ${tax.tax_name}`}
                  >
              ...
              <div className="mb-3">
                ...
                <p className="text-lg font-semibold text-primary-600">
                  {formatPercentage(tax.tax_percentage)}
                </p>
              </div>
              
              <div className="flex items-center text-xs text-gray-500">
                <Calendar className="w-3 h-3 mr-1" />
                <span>Creado: {formatDate(tax.created_at)}</span>
              </div>
            </div>
