...
import { Edit, Trash2, Calendar, ChevronUp, ChevronDown, ChevronsUpDown } from 'lucide-react';
import { WeekWithDetails } from '../../types/week';
...
interface WeekListProps {
  ...
  onEdit: (week: WeekWithDetails) => void;
  onDelete: (week: WeekWithDetails) => void;
  loading?: boolean;
    ...
    return (
      <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
        ...
        <p className="text-gray-600">
          No hay semanas que coincidan con los criterios de búsqueda
        </p>
      </div>
    );
  }
          ...
          >
            ...
            <div className="md:hidden">
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    title="Editar semana"
                    aria-label={`Editar semana ${week.week_name}`}
                  >
                  ...
                  <button
                    ...
                    aria-label={`Eliminar semana ${week.week_name}`}
                  >
              ...
              <div className="mb-3">
                ...
                <p className="text-gray-600 text-sm">
                  Menú: {week.menu_name || 'Sin menú asignado'}
                </p>
              </div>
              
              <div className="flex items-center text-xs text-gray-500">
                <Calendar className="w-3 h-3 mr-1" />
                <span>Creado: {formatDate(week.created_at)}</span>
              </div>
            </div>
            ...
            <div className="hidden md:block">
              <div className="grid grid-cols-10 gap-4 items-center">
                ...
                <div className="col-span-3">
                  <p className="text-gray-600 text-sm">
                    {week.menu_name || 'Sin menú asignado'}
                  </p>
                </div>
