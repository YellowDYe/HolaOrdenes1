...
import { Edit, Trash2, Truck, Calendar, ChevronUp, ChevronDown, ChevronsUpDown, User, Mail, Phone, MapPin, ToggleLeft, ToggleRight } from 'lucide-react';
              ...
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    aria-label={`${supplier.is_active ? 'Desactivar' : 'Activar'} proveedor ${supplier.supplier_name}`}
                  >
                    {supplier.is_active ? (
                  ...
                  <button
                    ...
                    aria-label={`Editar proveedor ${supplier.supplier_name}`}
                  >
                  ...
                  <button
                    ...
                    aria-label={`Eliminar proveedor ${supplier.supplier_name}`}
                  >
