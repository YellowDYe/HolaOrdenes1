...
import { Edit, Trash2, Settings, Calendar, ChevronUp, ChevronDown, ChevronsUpDown } from 'lucide-react';
...
interface StepListProps {
  steps: CookingStep[];
  onEdit: (step: CookingStep) => void;
  onDelete: (step: CookingStep) => void;
  loading?: boolean;
    ...
    return (
      <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
        ...
        <p className="text-gray-600">
          No hay procesos que coincidan con los criterios de búsqueda
        </p>
      </div>
    );
  }
            ...
            <div className="md:hidden">
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    aria-label={`Editar proceso ${step.cooking_steps_name}`}
                  >
                  ...
                  <button
                    ...
                    aria-label={`Eliminar proceso ${step.cooking_steps_name}`}
                  >
              ...
              <div className="mb-3">
                <h3 className="text-lg font-semibold text-gray-900 mb-1">
                  {step.cooking_steps_name}
                </h3>
                <p className="text-gray-600 text-sm leading-relaxed mb-2">
                  {step.cooking_steps_description}
                </p>
              </div>
              
              <div className="flex items-center text-xs text-gray-500">
                <Calendar className="w-3 h-3 mr-1" />
                <span>Creado: {formatDate(step.created_at)}</span>
              </div>
            </div>
