...
import { Edit, Trash2, Truck, Calendar, ChevronUp, ChevronDown, ChevronsUpDown } from 'lucide-react';
...
interface OptionListProps {
  ...
  onDelete: (option: DeliveryOption) => void;
  loading?: boolean;
    ...
    return (
      <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-2">
          No se encontraron opciones de envío
        </h3>
        <p className="text-gray-600">
          No hay opciones que coincidan con los criterios de búsqueda
        </p>
      </div>
    );
  }
            ...
            <div className="md:hidden">
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    title="Editar opción"
                    aria-label={`Editar opción ${option.delivery_options_name}`}
                  >
                  ...
                  <button
                    ...
                    aria-label={`Eliminar opción ${option.delivery_options_name}`}
                  >
              ...
              <div className="mb-3">
                <h3 className="text-lg font-semibold text-gray-900 mb-1">
                  {option.delivery_options_name}
                </h3>
                <p className="text-gray-600 text-sm leading-relaxed mb-2">
                  {option.delivery_options_description}
                </p>
                <p className="text-lg font-semibold text-gray-900">
                  {formatCurrency(option.delivery_options_price)}
                </p>
              </div>
            </div>
